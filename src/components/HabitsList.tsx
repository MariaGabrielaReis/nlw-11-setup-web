  ...
  return (
    <div className="mt-6 flex flex-col gap-3">
      {habitsInfo?.possibleHabits.map(habit => (
        ...
        >
          <div className="h-8 w-8 rounded-lg flex items-center justify-center bg-zinc-900 border-2 border-zinc-800 group-data-[state=checked]:bg-blue-600 group-data-[state=checked]:border-blue-600 transition-colors group-focus:ring-2 group-focus:ring-blue-700 group-focus:ring-offset-2 group-focus:ring-offset-background">
            <Checkbox.Indicator>
